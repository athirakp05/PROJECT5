...
def registration(request):
    if request.method == "POST":
        ...
        if (CustomUser.objects.filter(email=email).exists()):
            ...
            user = CustomUser.objects.create_user(first_name=firstname, last_name=lastname, email=email, phone=phone,
                                                  username=username, role='CUSTOMER')  # Change role as needed
